											...
											<ul>
												<li className="menu-item-has-children active">
													...
													<ul className="sub-menu">
														...
														<li className="menu-item-has-children">
															<a href='index-2.html' className="active">home v.2</a>
															<ul className="sub-menu">
																<li>
														...
														<div className="overlay-black clearfix">
															...
															<div className="leftside-content">
																...
																<div className="copyright-text">
																	<p className="m-0">©2019 <a href="#!" className="yellow-color">Harmoni.com</a> all right reserved, made with <i className="fas fa-heart"></i> by jThemes Studio </p>
																</div>
															</div>
				...
				<div id="sidebar" className="sidebar">
					...
					<div className="sidebar-form">
						<form action="#">
							...
							<label for="altmenu-sidebar-search"><i className="fas fa-search"></i></label>
						</form>
					</div>
					{/* <!-- sidebar-form - end --> */}
								...
								<div id="alt-login-modal" className="reglog-modal-wrapper mfp-hide clearfix" style={{backgroundimage:' url(assets/images/login-modal-bg.jpg)'}}>
									<div className="overlay-black clearfix">
										...
										<div className="leftside-content">
											...
											<div className="copyright-text">
												<p className="m-0">©2018 <a href="#!" className="yellow-color">Harmoni.com</a> all right reserved, made with <i className="fas fa-heart"></i> by jThemes Studio </p>
											</div>
										</div>
										{/* <!-- leftside-content - end --> */}
